...
// Import FAQ data from faqQuestions.jsx
import FaqQuestions from '../faqs/faqQuestions.jsx';
...
const FaqSection = () => {
  ...
  // Extract faqData from FaqQuestions component (assuming it's exported or accessible)
  // For simplicity, replicating the faqData here based on the provided content
  const faqData = [
    {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen">
      <div className="max-w-4xl mx-auto p-4 w-full">
        <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-center mb-6">Frequently asked questions</h2>
        ...
        <div className="text-center mt-6">
          <button
            ...
            className="text-white px-6 py-2 rounded-md hover:opacity-90 transition-colors hover:cursor-pointer"
          >
