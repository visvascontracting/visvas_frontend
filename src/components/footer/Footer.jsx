          ...
          {showButtons && !isModalOpen && (
            <>
              ...
              <motion.button
                ...
                onClick={scrollToTop}
                className="fixed bottom-6 left-6 bg-[var(--tertiary-text)] hover:bg-[var(--tertiary-text)]/80 text-white p-3 md:p-4 rounded-full shadow-lg transition-colors z-50 hover:cursor-pointer"
              ...
              <motion.a
                ...
                className="fixed bottom-20 right-6 bg-green-500 hover:bg-green-600 text-white p-3 md:p-4 rounded-full shadow-lg transition-all duration-300 z-50 hover:cursor-pointer hover:scale-110"
              ...
              >
                ...
                <span className="text-md md:text-lg lg:text-xl">Book a Meeting</span>
              </motion.button>
            </>
          )}
        </AnimatePresence>
